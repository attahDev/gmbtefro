...
export default function NewsletterSignup() {
    ...
    return (
        <section className="relative flex w-full justify-center overflow-x-hidden bg-[#FFD700] py-12 pb-24 sm:py-16 sm:pb-28 md:py-24 md:pb-32">
            <div className="relative w-full max-w-[1400px] px-4 sm:px-6 md:px-12">
                <div className="relative mx-auto w-full max-w-[1135px]">
                    {/* Blue Card */}
                    <motion.div
                        initial={{ opacity: 0, y: 60 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.8, ease: "easeOut" }}
                        className="relative z-20 h-auto w-full bg-[#001F3F] p-6 text-left text-white shadow-xl sm:p-12 lg:h-[600px] lg:w-[820px] lg:p-16"
                    >
                        ...
                        {error && (
                            <div className="mb-6 inline-block rounded-xl border border-red-500 bg-red-500/20 p-4 text-red-200">
                                {error}
                            </div>
                        )}
                    ...
                    {/* Decorative pattern */}
                    <div className="pointer-events-none absolute bottom-[-350px] right-[-350px] rotate-[-20deg] select-none opacity-10">
