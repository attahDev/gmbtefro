...
const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-[#001F3F] text-white overflow-hidden flex items-center justify-center min-h-[85vh] sm:min-h-[90vh]">
      {/* Bottom yellow gradient */}
      <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-yellow-500/80 to-transparent z-0" />

      {/* Main content container */}
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-12 lg:py-0 gap-8 md:gap-12 lg:gap-16 xl:gap-20">
        {/* Left text section */}
        <div className="flex flex-col justify-center gap-6 md:gap-8 lg:gap-10 xl:gap-12 w-full lg:max-w-[600px] text-center lg:text-left">
          {/* Badge */}
          <div className="inline-flex items-center self-center lg:self-start px-3 py-1.5 bg-slate-700/50 text-xs sm:text-sm rounded-full max-w-full sm:max-w-fit">
            <span className="mr-2 sm:mr-4 shrink-0">
              {/* Logo SVG */}
            ...
            <span className="text-[10px] sm:text-xs text-white leading-tight">
              GREATER MANCHESTER BLACK TECH EXPO 
            </span>
          </div>

          {/* Heading */}
          <h1 className="text-white font-open-sans text-3xl sm:text-5xl md:text-[64px] font-semibold leading-[1.1] tracking-tight">
          ...
          {/* Description */}
          <p className="text-[#DBEAFE] text-base sm:text-lg text-center lg:text-left leading-relaxed max-w-2xl mx-auto lg:mx-0">
            Bringing Greater Manchester&apos;s diverse talent closer to{" "}
            <br className="hidden sm:block" />
            mentorship, jobs, and innovation in technology.
          </p>

          {/* Buttons */}
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
            <Link to="/login" className="bg-[#D7263D] hover:bg-[#D7263D] text-white font-medium px-6 sm:px-8 py-3 rounded-lg transition-all shadow-md whitespace-nowrap">
              Join the Movement →
            </Link>
            <a href="#events" className="flex items-center justify-center gap-2  hover:bg-white/20 border border-white/20 px-6 sm:px-8 py-3 rounded-lg transition-all whitespace-nowrap">
        ...
        {/* Right image section */}
        <div className="relative w-full lg:flex-1 flex items-center justify-center max-w-2xl lg:max-w-none">
          ...
          <div className="hidden md:block relative w-full h-[400px] md:h-[500px] lg:h-[600px]">
            ...
            <motion.img
              ...
              initial={{ y: 0 }}
              animate={floatTop}
              className="absolute -top-6 left-4 md:left-8 lg:left-10 w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-[150px] lg:h-[150px] object-cover rounded-2xl border-4 border-white shadow-lg"
            />
            ...
            <motion.img
              ...
              initial={{ y: 0 }}
              animate={floatBottom}
              className="absolute -bottom-6 right-auto lg:left-[50%] w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-[150px] lg:h-[150px] object-cover rounded-2xl border-4 shadow-lg border-white"
            />
          </div>
